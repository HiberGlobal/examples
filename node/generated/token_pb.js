...
goog.exportSymbol('proto.hiber.token.TokenPermission', null, global);
 ...
 * @const
 */
proto.hiber.token.Token.repeatedFields_ = [5];
 ...
 * @return {!Array.<!proto.hiber.token.TokenPermission>}
 */
proto.hiber.token.Token.prototype.getPermissionsList = function() {
  return /** @type {!Array.<!proto.hiber.token.TokenPermission>} */ (jspb.Message.getRepeatedField(this, 5));
};


/** @param {!Array.<!proto.hiber.token.TokenPermission>} value */
proto.hiber.token.Token.prototype.setPermissionsList = function(value) {
  jspb.Message.setField(this, 5, value || []);
};


/**
 * @param {!proto.hiber.token.TokenPermission} value
 * @param {number=} opt_index
 */
proto.hiber.token.Token.prototype.addPermissions = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 5, value, opt_index);
};


proto.hiber.token.Token.prototype.clearPermissionsList = function() {
...
proto.hiber.token.CreateTokenRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.hiber.token.CreateTokenRequest.repeatedFields_, null);
};
 ...
 * @const
 */
proto.hiber.token.CreateTokenRequest.repeatedFields_ = [3];
 ...
 * @return {!Array.<!proto.hiber.token.TokenPermission>}
 */
proto.hiber.token.CreateTokenRequest.prototype.getPermissionsList = function() {
  return /** @type {!Array.<!proto.hiber.token.TokenPermission>} */ (jspb.Message.getRepeatedField(this, 3));
};


/** @param {!Array.<!proto.hiber.token.TokenPermission>} value */
proto.hiber.token.CreateTokenRequest.prototype.setPermissionsList = function(value) {
  jspb.Message.setField(this, 3, value || []);
};
 ...
 * @param {number=} opt_index
 */
proto.hiber.token.CreateTokenRequest.prototype.addPermissions = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};


proto.hiber.token.CreateTokenRequest.prototype.clearPermissionsList = function() {
  this.setPermissionsList([]);
};
