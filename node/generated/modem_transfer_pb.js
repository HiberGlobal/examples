...
proto.hiber.modem.PrepareModemForReturnRequest.Response.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    modemReturn: (f = msg.getModemReturn()) && proto.hiber.modem.ModemTransferReturnLine.toObject(includeInstance, f)
  };
...
/**
 * optional ModemTransferReturnLine modem_return = 2;
 * @return {?proto.hiber.modem.ModemTransferReturnLine}
 */
proto.hiber.modem.PrepareModemForReturnRequest.Response.prototype.getModemReturn = function() {
  return /** @type{?proto.hiber.modem.ModemTransferReturnLine} */ (
    jspb.Message.getWrapperField(this, proto.hiber.modem.ModemTransferReturnLine, 2));
};


/** @param {?proto.hiber.modem.ModemTransferReturnLine|undefined} value */
proto.hiber.modem.PrepareModemForReturnRequest.Response.prototype.setModemReturn = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.hiber.modem.PrepareModemForReturnRequest.Response.prototype.clearModemReturn = function() {
  this.setModemReturn(undefined);
};
 ...
 * @return {!boolean}
 */
proto.hiber.modem.PrepareModemForReturnRequest.Response.prototype.hasModemReturn = function() {
  return jspb.Message.getField(this, 2) != null;
};
