...
func (ModemTransfer_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor13, []int{0, 0} }
...
func (ModemTransfer_Status) EnumDescriptor() ([]byte, []int) { return fileDescriptor13, []int{0, 1} }
...
func (*ModemTransfer) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (*ModemTransferReturnLine) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1} }
...
func (*ModemTransferSelection) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }
...
func (*TransferModemsRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{3} }
...
func (*ListModemTransfersRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{4} }
...
func (*CancelModemTransferRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{5} }
...
func (*ReceivedModemTransferRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{6} }
...
func (*NotReceivedModemTransferRequest) Descriptor() ([]byte, []int) {
...
func (*PrepareModemForReturnRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{8} }
...
func (*DeleteModemTransferReturnLinesRequest_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{9, 0}
}
...
func (*SendReturnRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{11} }
...
func (*SendReturnRequest_Response) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{11, 0} }
...
func init() { proto.RegisterFile("modem_transfer.proto", fileDescriptor13) }
